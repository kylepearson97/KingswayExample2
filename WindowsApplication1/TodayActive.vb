...
Public Class TodayActive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.TodayActive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTodayActive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TodayActive = New TodayActive()
        rpt.Site = Me.Site
        Return rpt
    End Function
